...
class AppView:
    def __init__(self, root, controller):
        ...
        # Register Button
        self.btn_register = ttk.Button(self.sidebar, text="Register", command=self.on_register_click)
        self.btn_register.pack(pady=10, padx=10, fill="x")
        ...
        # PROFILE
        self.profile = tk.Label(root, text="PROFILE", bg="lightpink")
    ...
    def on_register_click(self):
        ...
        # In the future, you can add registration logic here
